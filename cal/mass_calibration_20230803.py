...
data = ChannelGroup(file, excludeStates=[])
defbinsize = 0.1
...
ds.calibrationPlanAddPoint(8785, "MgKAlpha", states=cal_states)
ds.calibrationPlanAddPoint(10285, "AlKAlpha", states=cal_states)
ds.calibrationPlanAddPoint(11864, "SiKAlpha", states=cal_states)
ds.calibrationPlanAddPoint(17081, "ClKAlpha", states=cal_states)
ds.calibrationPlanAddPoint(20900, "KKAlpha", states=cal_states)
ds.calibrationPlanAddPoint(27051, "TiKAlpha", states=cal_states)
ds.calibrationPlanAddPoint(36115, "FeKAlpha", states=cal_states)
ds.calibrationPlanAddPoint(43418, "CuKAlpha", states=cal_states)
