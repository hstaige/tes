...
d = '/home/tim/research/tes/cal_data/'
today = "20230728"
rn = "0005"
...
#plt.show()
# asdfas
print(data.external_trigger_rowcount_as_seconds)
...
ds.calibrationPlanAddPoint(7894, "MgKAlpha", states=todaycal)
ds.calibrationPlanAddPoint(9295, "AlKAlpha", states=todaycal)
ds.calibrationPlanAddPoint(10785, "SiKAlpha", states=todaycal)
ds.calibrationPlanAddPoint(15786, "ClKAlpha", states=todaycal)
ds.calibrationPlanAddPoint(19465, "KKAlpha", states=todaycal)
ds.calibrationPlanAddPoint(25430, "TiKAlpha", states=todaycal)
ds.calibrationPlanAddPoint(34069, "FeKAlpha", states=todaycal)
ds.calibrationPlanAddPoint(40980, "CuKAlpha", states=todaycal)
