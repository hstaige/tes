...
d = "/home/pcuser/data"
date = "20221214"                       #date
rn = "0003"                             #run number, can be found in dastard command 
state1 = "A"
...
ds.calibrationPlanAddPoint(20660, "KKAlpha", states=state1)
ds.calibrationPlanAddPoint(37140, "FeKAlpha", states=state1)
# ds.calibrationPlanAddPoint(37150, "FeKBeta", states=state1)
ds.calibrationPlanAddPoint(27252, "TiKAlpha", states=state1)
ds.calibrationPlanAddPoint(9853, "AlKAlpha", states=state1)
ds.calibrationPlanAddPoint(16700, "ClKAlpha", states=state1)
ds.calibrationPlanAddPoint(11432, "SiKAlpha", states=state1)
...
data.plotHist( np.arange(0,10000,1), "energy", coAddStates=False, states="A")
